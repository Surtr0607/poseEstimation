from model.keypointsModel import *
import utils.utils as utils
import numpy as np
import cv2

'''
    model that used for detecting the key-points of body
'''


class Body(object):
    def __init__(self, model_path):
        self.model = keypoints_model()
...
# img = cv2.imread(r"C:\Users\34779\PycharmProjects\COMP6211CW\res\456.png")
# img = cv2.resize(img, (700,400))
# candidate, subset = body_estimation(img)
# canvas = utils.draw_bodypose(img, candidate, subset)
